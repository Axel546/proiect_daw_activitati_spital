...
<div class="form-section" style="margin-bottom: 20px;">
    ...
    <form method="GET" style="display: flex; gap: 15px; flex-wrap: wrap; align-items: end;">
        ...
        <div>
            ...
            <a href="index.php" class="btn btn-secondary" style="margin-left: 10px;">Șterge</a>
        </div>
    </form>
</div>
            ...
            <tbody>
                <?php foreach ($activities as $activity): ?>
                    <tr style="border-bottom: 1px solid #eee;">
                        ...
                        <td style="padding: 12px;">
                            <a href="show.php?id=<?php echo $activity['id']; ?>" class="btn btn-secondary" style="padding: 5px 10px; font-size: 12px;">Vezi</a>
                            <?php if (canEditActivity($activity['id'], $pdo)): ?>
                                <a href="edit.php?id=<?php echo $activity['id']; ?>" class="btn" style="padding: 5px 10px; font-size: 12px; margin-left: 5px;">Editează</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
